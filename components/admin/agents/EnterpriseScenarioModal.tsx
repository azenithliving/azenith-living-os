...
const SCENARIOS = [
  {
    ...
    agentsInvolved: ['Vanguard', 'PRIME', 'Analyst', 'Ops', 'Security', 'Learner'],
    tablesAffected: ['leads', 'sales_orders', 'inventory_items', 'production_jobs', 'agent_memory'],
    description: 'يقوم Vanguard باستقبال طلب العميل طارق الدسوقي بميزانية 350 ألف ج.م لصالون إمبراطوري، ويصدر عقد البيع، ثم يقوم PRIME بحساب استهلاك خشب الزان والأقمشة، ويتحقق من المخزون، ويصدر أمر تصنيع حقيقي في جدول production_jobs، بينما يحسب Analyst هامش الربح (40.5%).',
  },
  {
    ...
    agentsInvolved: ['Ops', 'PRIME', 'Vanguard', 'Analyst'],
    tablesAffected: ['inventory_items', 'sales_orders'],
    description: 'يرصد Ops انخفاض مخزون خشب الزان إلى 2.2 م³، ليقوم PRIME بحصر الأوامر المعلقة واقتراح دفعة توريد 6 م³، ويقوم Vanguard بجدولة التسليمات لعدم التأخير، بينما يحسب Analyst الميزانية المطلوبة.',
  },
  {
