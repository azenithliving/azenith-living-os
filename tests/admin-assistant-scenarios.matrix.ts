...
export const ADMIN_SCENARIO_MATRIX: ScenarioExpectation[] = [
  ...
  { message: "اعرض النسخ الاحتياطية", kind: "ultimate_tool", toolName: "backup_list" },
  { message: "list all backups", kind: "ultimate_tool", toolName: "backup_list" },
  { message: "فحص تقني عميق للنظام", kind: "ultimate_tool", toolName: "system_health_check" },
  { message: "المؤشرات الآن", kind: "ultimate_tool", toolName: "metrics_realtime" },
  { message: "وين وصلنا في الهدف؟", kind: "ultimate_tool", toolName: "goal_check_progress" },
  { message: "طوّر قدراتك ومهاراتك", kind: "command", command: "evolve" },
  { message: "راقب النظام الآن", kind: "health" },
  { message: "اعرض العملاء الجدد", kind: "ultimate_tool", toolName: "lead_list" },
  { message: "افحص صحة محتوى الصفحة الرئيسية", kind: "ultimate_tool", toolName: "content_health_check" },
  { message: "فرص الإيراد", kind: "ultimate_tool", toolName: "revenue_opportunities" },
  { message: "اعرض المنتجات", kind: "ultimate_tool", toolName: "product_list" },
  { message: "ابحث عن اتجاهات التصميم الفاخر 2026", kind: "ultimate_tool", toolName: "web_search" },
  { message: "استرجع آخر نسخة احتياطية", kind: "ultimate_tool", toolName: "backup_restore" },
