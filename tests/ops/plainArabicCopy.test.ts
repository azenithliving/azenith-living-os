...
import { renderGscResult } from "@/lib/ops/gsc";
import { renderRivalsDigest, type RivalDigestEntry } from "@/lib/ops/rivals";
import { verdictForExperiment } from "@/lib/ops/experiment-verdict";
import { buildDailyStory } from "@/lib/ops/daily-story";
import { explainGap, type GapFacts } from "@/lib/ops/gap-contract";
import { renderForecast, forecastFromSeries } from "@/lib/ops/forecast";
import { renderAnomalyDigest } from "@/lib/ops/anomaly";
import { renderSelfReport, buildSelfModel, AUTONOMOUS_ORGANS, type SelfModel } from "@/lib/ops/self-model";
