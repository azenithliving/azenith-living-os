 ...
 * GET  /api/admin/ops/experiments            → list all
 * GET  /api/admin/ops/experiments?id=X&stats=1 → stats for one
 * POST /api/admin/ops/experiments { action: 'start'|'pause'|'conclude', experiment_id }
 */
