          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-[#C5A059]">مدير الموقع</h1>
                  <p className="text-xs text-gray-400">Site Manager • ماستر مايند</p>
                </div>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-[#C5A059]/10 rounded-full border border-[#C5A059]/30">
                ...
                <span className="text-sm text-[#C5A059]">مدير الموقع</span>
              </div>
            </div>
