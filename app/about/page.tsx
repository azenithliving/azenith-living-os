    ...
    <main className="px-6 py-12 md:px-10 lg:px-16">
      <div className="mx-auto max-w-4xl space-y-16">
        ...
        <section className="text-center space-y-6 animate-fadeInUp">
          <h1 className="font-serif text-5xl md:text-7xl text-white">{isRTL ? aboutData.title : aboutData.titleEn}</h1>
          ...
          <p className="max-w-2xl mx-auto text-xl leading-8 text-white/80">{isRTL ? aboutData.story : aboutData.storyEn}</p>
        </section>

        {/* Values */}
        <section className="grid md:grid-cols-3 gap-6">
          {(isRTL ? aboutData.values : aboutData.valuesEn).map((value, index) => (
