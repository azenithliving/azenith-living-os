...
export const AUTONOMOUS_ORGANS: Organ[] = [
  { label: "مؤشر الفخامة المقاس", cadence: "كل يوم", source: "@/lib/ops/luxury-v2" },
  { label: "الأهداف المهددة", cadence: "كل يوم", source: "@/lib/ops/goal-risk" },
  { label: "مراقبة شذوذ الزوار", cadence: "كل يوم", source: "@/lib/ops/anomaly" },
  { label: "كاناري الصفحات العامة", cadence: "كل يوم", source: "@/lib/ops/canary" },
  { label: "قياس المنافسين", cadence: "كل اثنين", source: "@/lib/ops/rivals" },
  { label: "تدقيق ردود السرب", cadence: "كل أحد", source: "@/lib/ops/self-audit" },
  { label: "إغلاق المهام المعلقة", cadence: "كل يوم", source: "@/lib/ops/task-reconcile" },
  { label: "تقرير الصباح على تليجرام", cadence: "كل يوم", source: "@/lib/ops/daily-story" },
];
