...
export const BENCHMARKS: BenchmarkDefinition[] = [
  {
    ...
    applicableAgents: ['ops-lead', 'ops-ux', 'ops-analytics', 'ops-seo', 'ops-dev', 'ops-qa'],
    run: (sample) => ({
      checks: [
  ...
  },
  {
    ...
    applicableAgents: ['ops-lead', 'ops-content', 'ops-visual', 'ops-seo', 'ops-ux', 'ops-analytics', 'ops-dev', 'ops-qa'],
    run: (sample) => ({
      checks: [
  ...
  },
  {
    ...
    applicableAgents: ['ops-content', 'ops-lead'],
    run: (sample) => ({
      checks: [
  ...
  },
  {
    ...
    applicableAgents: ['ops-ux', 'ops-analytics', 'ops-seo', 'ops-dev', 'ops-qa'],
    run: (sample) => ({
      checks: [
