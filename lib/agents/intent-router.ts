...
export const TOOL_CATALOG: Array<{ name: string; desc: string }> = [
  { name: "ops_self", desc: "تقرير ذاتي حي بقدرات السرب وأدواته وحدوده وعداداته الحالية" },
  { name: "ops_world", desc: "نموذج عالم الدار: مبيعات 90 يومًا والأكثر مبيعًا والكتالوج والزوار والأهداف والموسم الحالي" },
  { name: "gsc_queries", desc: "كلمات البحث الحقيقية من Google Search Console (أو رفض مسمّى ينقص المتغيرات)" },
  { name: "ops_rivals", desc: "قياس حيّ للمنافسين: روابط منتجاتهم، الأسعار الظاهرة، إشارات الواتساب" },
  { name: "ops_forecast", desc: "توقع مبيعات الأيام أو الشهر القادم بحساب Holt-Winters على الطلبات الفعلية مع نسبة الخطأ المقاسة" },
  { name: "draft_list", desc: "جرد المسودات المعلقة فعليًا وعدّها بأرقام حقيقية" },
  ...
  { name: "ops_goals_risk", desc: "عرض الأهداف المهددة من قاعدة البيانات" },
