-- ================================================================
-- Migration 038: Expand API Keys System to Support 17 Providers
-- ================================================================
-- Purpose: Expand provider support to 17 AI services with backup 
...
-- Step 2: Expand provider constraint to support all 17 providers
...
COMMENT ON TABLE api_keys IS 'Stores API keys for 17 AI providers with rotation, cooldown, and backup support';
